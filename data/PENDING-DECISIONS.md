...
## WAITING ON OTHERS (Garry monitors — no action needed)

| Item | From | Status |
|---|---|---|
| **Mary Ave seller response** | Seller via Lindia | Due Apr 23 — accept/counter/reject |
| **Wilborn contractor quotes** | Google search + Darren + Justin + Lindia | Garry monitors, sends to Telegram |
| **Heather — utility costs** | heather@avenuestl.com | Email sent Apr 22 |
| **Earl lease + ledger** | Lindia Robins | Needed before formal offer |
| **Ewell/Renfrew comps** | Lindia Robins | Sleeper 4BR 63137 leads |
| **NREIG insurance quotes** | Kathy Garcia | Mary Ave + master policy |
| **Hazelcrest countersign** | Heather Stone | Listing contract |
| **STL assessed values** | Background agent | Tax appeal — deadline Jul 14 |
| **Laura App Password** | Laura (Telegram) | Jenny Gmail fix — Garry handles |

---

## PRE-APPROVED AUTONOMOUS (Garry handles, no check-in)
- All PM outreach, email sends, monitoring
- Contractor quote requests (not access arrangements)
- Laura/Jenny/course support — full authority
- Infrastructure fixes, script builds, memory updates
- Gmail triage, email marking, calendar management

## NEVER AUTONOMOUS
- Any spending (even $1)
- Signing contracts / DocuSigns
- Arranging site access (until Patrick approves contractor)
- New human outreach not already in flight
